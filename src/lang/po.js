...
export default function Strings() {
  return {
    ...
    wygTitle6: "lançamento do web3 MVP em Maio de 2023",
    ...
    aboutDesc1: `Com combate chamativo, gráficos estelares e vários modos de jogo, ${config.appName} é o primeiro RPG hack-and-slash F2P de qualidade AAA no lançamento do blockchain na Polygon`,
    aboutDesc2:

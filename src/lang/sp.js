...
export default function Strings() {
  return {
    ...
    buyBefore:
      "Estén atentos a los anuncios de IDO. Precio de lanzamiento:",
    soldTtl: "Vendido",
    raisedTtl: "RECAUDADO",
    ...
    wygTitle6: "El MVP de Web3 se lanzará en mayo de 2023",
    wygTitle7:
    ...
    aboutDesc1: `Con un combate llamativo, gráficos estelares y varios modos de juego, ${config.appName} es el primer RPG F2P hack-and-slash de ritmo rápido y calidad AAA de la cadena de bloques que se lanza en Polygon.`,
    aboutDesc2:

...
export default function Strings() {
  return {
    ...
    wygTitle6: "web3 MVP dilancarkan pada Mei 2023",
    ...
    aboutDesc1: `Mempunyai pertempuran yang mencolok, grafik cemerlang dan pelbagai mod permainan, ${config.appName} ialah RPG hack-and-slash F2P berkualiti AAA yang pertama dalam pelancaran blockchain di Polygon.`,
    aboutDesc2:

...
export default function Strings() {
  return {
    ...
    wygTitle6: "MVP web3 diluncurkan pada Mei 2023",
    ...
    aboutDesc1: `Menawarkan pertarungan yang mencolok, grafis yang luar biasa, dan berbagai mode permainan, ${config.appName} adalah RPG hack-and-slash F2P serba cepat berkualitas AAA pertama di blockchain yang diluncurkan di Polygon.`,
    aboutDesc2:

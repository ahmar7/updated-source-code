...
export default function Strings() {
  return {
    ...
    wygTitle6: "web3 MVP стартует в мае 2023 года.",
    ...
    aboutDesc1: `Хвастаясь яркими боями, звездной графикой и различными игровыми режимами, ${config.appName} - это первая ролевая игра F2P hack-and-slash на блокчейне качества ААА с быстрым темпом, которую запускает Polygon.`,
    aboutDesc2:

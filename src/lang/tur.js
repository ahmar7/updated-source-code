...
export default function Strings() {
  return {
    ...
    wygTitle6: "Web3 MVP Mayıs 2023'te piyasaya çıkıyor",
    ...
    aboutDesc1: `Gösterişli dövüşler, mükemmel grafikler ve çeşitli oyun modları sunan ${config.appName}, Polygon'da lansmanı yapılan blok zincirindeki ilk AAA kalitesinde hızlı tempolu F2P hack-and-slash RPG'dir.`,
    aboutDesc2:
